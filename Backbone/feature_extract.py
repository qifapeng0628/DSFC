...
def i3d_function():
    ...
    ckpt_path = r"C:\Users\pengq\Desktop\maetz\Video_MAE\vit_g_hybrid_pt_1200e_k710_ft.pth"
    parser = argparse.ArgumentParser()
    parser.add_argument("--snapshot1", help='path of testing model_weight', default='F:\\Backbone\\shanghaitech\\denseflow\\i3d\\{}_charades.pt'.format(a), type=str)
    parser.add_argument("--snapshot2", help='path of testing model_weight',default='F:\\Backbone\\shanghaitech\\denseflow\\i3d\\{}_charades.pt'.format(b), type=str)
