...
if __name__ == '__main__':
    ...
    if dataset == 'shanghaitech8':
        label_dict_path = '{}shanghaitech8\\GT'.format(args.dataset_path)
    elif dataset == 'UBnormal8':
        label_dict_path = '{}UBnormal8\\GT'.format(args.dataset_path)
    elif dataset == 'avenue':
        label_dict_path = '{}/avenue/GT'.format(args.dataset_path)
    elif dataset == 'ped2':
        label_dict_path = '{}/ped2/GT'.format(args.dataset_path)
    elif dataset == 'UCF_Crime8':
        label_dict_path = 'E:\\UCF_Crime8\\GT'
    ...
    binary_all_predict_np = scorebinary(all_predict_np, threshold=threshold)
    tn, fp, fn, tp = confusion_matrix(y_true=all_label_np, y_pred=binary_all_predict_np).ravel()
    all_ano_false_alarm = fp / (fp + tn)
    binary_normal_predict_np = scorebinary(normal_predict_np, threshold=threshold)
    ...
    binary_abnormal_predict_np = scorebinary(abnormal_predict_np, threshold=threshold)
